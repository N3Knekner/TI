<!DOCTYPE html>
	...
	<body style="font-family: Segoe UI">
		<button style="background-color: lightblue;" onclick="window.location.href = window.location.href.replace('criador.php','')">Voltar</button>
		...
		error_reporting(0);
			...
			if (isset($_GET['alterar'])){
				echo "<script>
					if(confirm('deseja realmente alterar?'))window.location.href = 'alterarCriador.php?delete=".$_GET['alterar']."&table=".$_GET["table"]."&cod=".$col[0]."&tipo=".$_GET["tipo"]."'
					</script>";
			}
